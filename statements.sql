...
-- Todos los usuarios tienen un lenguaje, así que esta consulta no mostrará resultados, pero es:
...
SELECT nombre, COUNT(*) AS cantidad_lenguajes FROM usuarios_lenguajes GROUP BY nombre;
